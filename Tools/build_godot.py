...
def main():
    ...
    parser = argparse.ArgumentParser(description='Build SP to the bin build folder: D:/Backup/Code/Qt/build_ScreenPlay_Qt_6.10.2_MSVC_Debug/bin')
    ...
    if not args.build_path:
        ...
        print("py build_godot.py --build_path D:/Backup/Code/Qt/build_ScreenPlay_Qt_6.10.2_MSVC_Debug/bin/")
        exit()
