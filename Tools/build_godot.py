...
def main():
    ...
    parser = argparse.ArgumentParser(description='Build K3000Map to the bin build folder: D:/Backup/Code/Qt/build_ScreenPlay_Qt_6.8.1_MSVC_Debug/bin')
    ...
    if not args.build_path:
        ...
        print("py build_godot.py --build_path D:/Backup/Code/Qt/build_ScreenPlay_Qt_6.8.1_MSVC_Debug/bin/")
        exit()
