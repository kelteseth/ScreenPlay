...
def download(aqt_path: Path, qt_platform: Path):
    ...
    # Windows: python -m aqt list-qt windows desktop --arch 6.8.2
    # Linux: python3  -m aqt list-qt linux desktop --arch 6.8.2
    ...
    # Windows: python -m aqt list-qt windows desktop --modules 6.8.2 win64_msvc2022_64
    # Linux:  python3 -m aqt list-qt linux  desktop --modules 6.8.2 linux_gcc_64
    # Linux:  python3 -m aqt list-qt mac  desktop --modules 6.8.2 clang_64
...
def setup_qt():
    ...
    if system() == "Windows":
        qt_platform = "win64_msvc2022_64" # 6.8.2 win64_msvc2022_64
    elif system() == "Darwin":
