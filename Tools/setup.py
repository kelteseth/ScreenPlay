...
def download(aqt_path: Path, qt_platform: Path):
    ...
    # Windows: python -m aqt list-qt windows desktop --arch 6.10.1
    # Linux: python3  -m aqt list-qt linux desktop --arch 6.10.1
    ...
    # Windows: python -m aqt list-qt windows desktop --modules 6.10.1 win64_msvc2022_64
    # Linux:  python3 -m aqt list-qt linux  desktop --modules 6.10.1 linux_gcc_64
    # Linux:  python3 -m aqt list-qt mac  desktop --modules 6.10.1 clang_64
...
def setup_qt():
    ...
    if system() == "Windows":
        qt_platform = "win64_msvc2022_64" # 6.10.1 win64_msvc2022_64
    elif system() == "Darwin":
