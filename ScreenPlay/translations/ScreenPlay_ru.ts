...
<context>
    ...
    <message>
        ...
        <translation type="obsolete">Помогите нам сделать ScreenPlay более быстрым и стабильным. Все собранные данные являются абсолютно анонимными и используются только в целях разработки!</translation>
    </message>
    <message>
