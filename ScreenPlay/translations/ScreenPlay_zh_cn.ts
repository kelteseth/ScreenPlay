...
*.mp4  *.mpg *.mp2 *.mpeg *.ogv *.avi *.wmv *.m4v *.3gp *.flv</source>
        <translation>依您的PC配置，最好转换您的壁纸到某种视频编码。如果性能都不好，您也可以尝试一个QML壁纸！支持的视频格式如下：
...
*.mp4  *.mpg *.mp2 *.mpeg *.ogv *.avi *.wmv *.m4v *.3gp *.flv</translation>
    ...
    <message>
        ...
        <translation>质量滑条。更大的值意味着更好的性能</translation>
    </message>
    <message>
