    ...
    Rectangle {
        ...
        RowLayout {
            ...
            Button {
                ...
                icon.source: "qrc:/qt/qml/ScreenPlayCore/assets/icons/icon_forum.svg"
                icon.width: 14
                icon.height: 14
                Layout.alignment: Qt.AlignVCenter
            }
            ...
            Button {
                ...
                icon.source: "qrc:/qt/qml/ScreenPlayCore/assets/icons/brand_reddit.svg"
                icon.width: 14
                icon.height: 14
                Layout.alignment: Qt.AlignVCenter
            }
            ...
            Button {
                ...
                icon.source: "qrc:/qt/qml/ScreenPlayCore/assets/icons/icon_report_problem.svg"
                icon.width: 14
                icon.height: 14
                Layout.alignment: Qt.AlignVCenter
            }
