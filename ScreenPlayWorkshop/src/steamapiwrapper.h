...
struct ItemUpdateData {
    ...
    QString m_metadata;
    ScreenPlayCore::Steam::ERemoteStoragePublishedFileVisibility visibility;
    QStringList m_tags;
    ...
    QPair<QString, ScreenPlayCore::Steam::EItemPreviewType> m_previewFile;
    QPair<QString, ScreenPlayCore::Steam::EItemPreviewType> m_previewVideo;
